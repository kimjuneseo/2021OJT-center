...
<style>
	...
	input[name="email"]{ margin-bottom: 50px;  }
...
<body>
	<div id="container">
			...
			<div id="s_title">아이디 찾기</div>
			<form action="memberFindIdPro.jsp" method="post" name="loginForm">
				<table>
					<tr>
						<td ><input type="text" name="name" class="t_input" placeholder="이름을 입력해주세요."></td>
					</tr>
					<tr>
						<td ><input type="text" name="tel" class="t_input" placeholder="전화번호를 입력해주세요."></td>
					</tr>
					<tr><td ><input type="submit" class="t_input find_id" value="아이디 찾기" id="btn_login"></td></tr>
