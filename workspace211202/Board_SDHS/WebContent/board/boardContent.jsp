...
* {box-sizing: border-box;margin: 0;padding: 0;}
	...
	input { width: 100%; height: 100%; border: hidden;}
	.btn { padding: 10px; background: #b4baba; border: none; border-radius: 5px; font-family: 'Noto Sans KR', sans-serif; color: #fff; cursor: pointer;}
	.btn:hover { background: #585555; color: #fff; transition: .5s }
	.grid { display: grid; }
	.flex { display: flex; }
	#container { width: 1500px; margin: 20px auto;}
	.form { border-top: 3px solid var(--line_color);}
	.form>div { height: 70px; border : 1px solid #999; border-bottom: none; border-right: none; border-left: none; border: 1px solid #999;}
	.content { grid-template-columns: 15% 85%;}
	.content div:nth-of-type(7), .content div:nth-of-type(8) { border-bottom: 3px solid #000;}
	.content_grid { grid-template-columns: 15% 43.5% 15% 43.5%;}
	.form .grid>div { background: var(--back_color); align-items: center;}
	.form h2 { color: var(--line_color); font-size: 1.4rem}
	...
	.content__text { font-family: 'Noto Sans KR', sans-serif; font-size: 1rem; color: #000; font-weight: 600; text-decoration: none;}
	.d_login { grid-template-columns: 80px 80px; justify-content: right; text-align: right;}
	.big__board { position: fixed; top: 250px; left: 1%}
	.big__board>div { border-top: 2px solid var(--line_color); padding: 10px}
	.read_count { grid-template-columns: 15% 85%;}
	.board__content { color: #666; width: 250px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;}
	.right { width: 75%; margin: 0 auto;}
	.right>.btns { padding-top: 10px; justify-content: center; gap: 20px;}
	.content___ { height: 500px}
</style>
